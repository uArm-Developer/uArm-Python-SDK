...
# Use the USBSerialAndroid_Swift class
from ..usbserialandroid_swift import UsbSerialAndroid_Swift
...
class Usbserialandroid_SwiftAPI():
    '''
    ...
    def __init__(self, **kwargs):
        ...
        self._nodes = {}
        # Use the USBSerialAndroid_Swift class
        self._nodes['swift'] = UsbSerialAndroid_Swift(self._ufc, 'swift', swift_iomap, **kwargs)
