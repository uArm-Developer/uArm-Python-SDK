...
SET_POLOR = "G2201 S{} R{} H{} F{}"
SET_PLOAR_RELATIVE = "G2205 S{} R{} H{} F{}"
SET_PUMP = "M2231 V{}"
SET_GRIPPER = "M2232 V{}"
...
# Grove
SET_GROVE_INIT = "M2300 N{} {}"  # "M2305 P{} N{} {}"
SET_GROVE_RELEASE = "M2304 P{}"
SET_GROVE_CONTROL = "M2302 N{} V{}" # "M2307 P{} {}"
SET_GROVE_REPORT = "M2301 N{} V{}"  # N10: color, N11: gesture  "M2306 P{} V{}"
REPORT_GROVE_PREFIX = "@10"  # @10 N10  "@11"
